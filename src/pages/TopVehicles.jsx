...
const VehicleClasses = ["Compact Cars", "Sedans", "SUVs", "Coupes", "Muscle Cars", "Sports Classics", "Sports Cars", "Super Cars", "Motorcycles", "Off-road Cars", "Industrial Vehicles", "Utility Vehicles", "Vans", "Cycles", "Boats", "Helicopters", "Planes", "Service Vehicles", "Emergency Vehicles", "Military Vehicles", "Commercial Vehicles", "Trains"];
		...
		<div className="container">
			...
			<div className="border-start">
				<div className="border-title text-center">
					Vehicle stats updates every 5 minutes
					<br />
					Last Updated: {new Date(state.timestamp).toTimeString()}
				</div>
