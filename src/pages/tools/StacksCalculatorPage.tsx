    ...
    <ContentBlock title="stacks/auction sell/buy calculator">
      <div className="flex flex-col justify-center items-center">
        ...
        <input
          ...
          className="block px-2 w-full max-w-sm py-1 text-center bg-white text-black"
          placeholder="..."
        />
        ...
        <input
          ...
          className="block px-2 w-full max-w-sm py-1 text-center spin bg-white text-black"
          placeholder="..."
        />
        ...
        <textarea
          ...
          readOnly
          className="block shadow-md p-1 w-full max-w-sm resize-none text-center bg-gray-400 border border-black outline-none text-black"
          rows={1}
        />
        ...
        <textarea
          value={result || '-'}
          readOnly
          className="block shadow-md p-1 w-full max-w-sm resize-none my-1 text-center bg-gray-400 border border-black outline-none text-black"
          rows={1}
        />
        <hr />
