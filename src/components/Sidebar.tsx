...
export default function Sidebar() {
  return (
    <>
      <aside className="w-fullbox-border bg-white dark:bg-kebab-bg-dm w-full min-w-[140px] sm:max-w-[200px] text-black dark:text-white h-fit dark:shdw text-center my-3 overflow-hidden border-r border-r-gray-400 dark:border-r-kebab-bg">
