...
export default function Sidebar() {
  return (
    <>
      <aside className="w-fullbox-border bg-kebab-bg-dm w-full min-w-[140px] sm:max-w-[200px]  text-white h-fit shdw text-center mb-3">
        {/* <aside className="w-fullbox-border rounded bg-kebab-bg-dm w-full min-w-[140px] max-w-[200px] py-5 text-white h-fit shdw"> */}
        <ul className="">
          <li className="font-sans bg-kebab-btn mb-2">Live</li>
          <OneItem to="/">Servers List</OneItem>
          <OneItem to="/playerfinder">Player Finder</OneItem>
          <li className="font-sans bg-kebab-btn my-2">Data</li>
          ...
          <li className="font-sans bg-kebab-btn my-2">Tools</li>
